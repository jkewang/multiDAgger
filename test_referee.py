...
class Referee(object):
    def __init__(self):
        ...
        self.test_policy = test_net.Testnet()
    ...
    def tick(self):
        ...
        self.agent_green.tick(torch.max(self.test_policy.choose_action(green_state)[0], 0)[1].item())

        red_state = self.agent_red.ask_state()
        self.agent_red.tick(torch.max(self.test_policy.choose_action(red_state)[0], 0)[1].item())
